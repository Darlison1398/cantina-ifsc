 ...
 * @author darli
 */
public class CadastrarCarteirinha extends javax.swing.JDialog {

    /**
     * Creates new form CadastrarCarteirinha
     */
    public CadastrarCarteirinha(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CADASTRAR CARTEIRINHA ESTUDANTIL");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarCarteirinha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastrarCarteirinha dialog = new CadastrarCarteirinha(new javax.swing.JFrame(), true);
