...
public class TemplateFornecedor extends javax.swing.JDialog {

    /**
     * Creates new form TestandoTemplate
     */
    public TemplateFornecedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/filtro (1).png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/carregando (2).png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TemplateFornecedor dialog = new TemplateFornecedor(new javax.swing.JFrame(), true);
