...
public class CadastroEndereco extends javax.swing.JFrame {
    ...
    public void setjButtonAdicionarBairro(JButton jButtonAdicionarBairro) {
        this.jButtonAdicionarBairro = jButtonAdicionarBairro;
    }

    public JButton getjButtonAdicionarCidade() {
        return jButtonAdicionarCidade;
    }

    public void setjButtonAdicionarCidade(JButton jButtonAdicionarCidade) {
        this.jButtonAdicionarCidade = jButtonAdicionarCidade;
    }

    public JButton getjButtonBuscaBairro() {
        return jButtonBuscaBairro;
    }

    public void setjButtonBuscaBairro(JButton jButtonBuscaBairro) {
        this.jButtonBuscaBairro = jButtonBuscaBairro;
    }

    public JButton getjButtonBuscaCidade() {
        return jButtonBuscaCidade;
    }

    public void setjButtonBuscaCidade(JButton jButtonBuscaCidade) {
        this.jButtonBuscaCidade = jButtonBuscaCidade;
    }
    ...
    public JTextField getjTCodigoCidade() {
        return jTCodigoCidade;
    }

    public void setjTCodigoCidade(JTextField jTCodigoCidade) {
        this.jTCodigoCidade = jTCodigoCidade;
    }

    public JTextField getjTDescricaoBairro() {
        return jTDescricaoBairro;
    }

    public void setjTDescricaoBairro(JTextField jTDescricaoBairro) {
        this.jTDescricaoBairro = jTDescricaoBairro;
    }

    public JTextField getjTDescricaoCidade() {
        return jTDescricaoCidade;
    }

    public void setjTDescricaoCidade(JTextField jTDescricaoCidade) {
        this.jTDescricaoCidade = jTDescricaoCidade;
    }
    ...
    private void initComponents() {
        ...
        jTCodigoCidade.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTCodigoCidadeActionPerformed(evt);
            }
        });

        jButtonAdicionarCidade.setBackground(new java.awt.Color(153, 255, 153));
        jButtonAdicionarCidade.setText("+");

        jButtonBuscaCidade.setBackground(new java.awt.Color(153, 255, 153));
        jButtonBuscaCidade.setText("...");

        jButtonAdicionarBairro.setBackground(new java.awt.Color(153, 255, 153));
        jButtonAdicionarBairro.setText("+");

        jButtonBuscaBairro.setBackground(new java.awt.Color(153, 255, 153));
        jButtonBuscaBairro.setText("...");

        jTDescricaoCidade.setEnabled(false);
        ...
        jPanelDadosLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelDadosLayout.createSequentialGroup()
                ...
                .addGroup(jPanelDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jFCep, javax.swing.GroupLayout.DEFAULT_SIZE, 97, Short.MAX_VALUE)
                ...
                .addGroup(jPanelDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelDadosLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jTCodigoCidade, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTBairro, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanelDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanelDadosLayout.createSequentialGroup()
        ...
        jPanelFundoLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelFundoLayout.createSequentialGroup()
                ...
                .addGroup(jPanelFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanelBotoes, javax.swing.GroupLayout.PREFERRED_SIZE, 769, Short.MAX_VALUE)
    ...
    private void jTCodigoCidadeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTCodigoCidadeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTCodigoCidadeActionPerformed
